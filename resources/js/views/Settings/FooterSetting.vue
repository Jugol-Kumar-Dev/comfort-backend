...
<template>
        ...
        <div class="col-md-6" v-for="(value, index) in customPages">
            <div class="card mb-5">
                <div class="card-body position-relative imgContainer">
                    ...
                    <div class="mt-1">
                        <input type="text" v-model="customPages[index].title" class="form-control mb-1" placeholder="e.g title">
                    ...
                    <button
                        ...
                        name="button"
                        @click="addRow">
                        <span class="svg-icon svg-icon-white svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Navigation/Plus.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <button
                        ...
                        type="button">
                        <span class="svg-icon svg-icon-white svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="row" v-if="!loading">
        ...
        <div class="col">
            <a href="#" class="card bg-light-danger cursor-pointer">
                <div class="card-body d-flex align-customPages-center justify-content-center">
